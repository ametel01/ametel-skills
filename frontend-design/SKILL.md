...
description: Create distinctive frontend interfaces. Use this skill when building or restyling web UI such as pages, apps, dashboards, components, posters, HTML/CSS, or React views.
