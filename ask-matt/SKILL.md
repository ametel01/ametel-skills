---
name: ask-matt
description: Use this skill when the user asks which Matt Pocock engineering skill or flow fits a situation, needs a route from idea to implementation, or wants to know whether to use grilling, handoff, prototype, PRD, issues, triage, or teaching workflows.
---
