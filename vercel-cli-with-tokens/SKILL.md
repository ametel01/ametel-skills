...
description: Use this skill when deploying, setting up Vercel, linking projects, managing env vars, or running Vercel CLI workflows with VERCEL_TOKEN token authentication.
metadata:
  author: vercel
  version: "1.0.0"
---
