---
name: upgrade-stripe
description: Use this skill when upgrading Stripe API versions, server-side SDKs, Stripe.js, mobile SDKs, webhook handlers, or API-versioned integration code.
---
