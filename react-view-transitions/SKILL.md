...
description: Use this skill when adding or reviewing React View Transition API work, including page or route transitions, shared element animations, list reorder animations, enter/exit animations, Suspense reveals, or Next.js view transitions.
license: MIT
metadata:
  author: vercel
  version: "1.0.0"
