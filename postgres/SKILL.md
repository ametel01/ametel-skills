...
| Query Patterns         | [references/query-patterns.md](references/query-patterns.md)     | SQL anti-patterns, JOINs, pagination, batch writes        |
| Security and RLS       | [references/security-rls.md](references/security-rls.md)         | Row-Level Security, policy performance, privileges        |
...
| Concurrency Patterns   | [references/concurrency-patterns.md](references/concurrency-patterns.md)       | Lock ordering, queues, advisory locks, deadlock avoidance       |
...
| Monitoring             | [references/monitoring.md](references/monitoring.md)                           | pg_stat views, EXPLAIN, logging, host metrics                  |
